...
const sendFriendRequest = async (req: IRequest, res: Response) => {
...
const acceptFriendRequest = async (req: IRequest, res: Response) => {
...
const declineFriendRequest = async (req: IRequest, res: Response) => {
  const { requestId } = req.params
  const userId = req.user?._id?.toString()
